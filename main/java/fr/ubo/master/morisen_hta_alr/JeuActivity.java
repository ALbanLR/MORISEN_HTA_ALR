...
public class JeuActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        music = MediaPlayer.create(JeuActivity.this,R.raw.song);
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if(snapshot.hasChild("player_id")){
                    ...
                    if(getWinPlayerId.equals(playerUniqueId)){
                        ...
                        // show win dialog
                        //winDialog = new WinDialog(fr.ubo.morpion.game.this, "You won the game");
                    }
                    else{

                        // show win dialog
                        //winDialog = new WinDialog(fr.ubo.morpion.game.this, "Opponent won the game");
                    }
    ...
    private void selectBox(ImageView imageView, int selectedBoxPosition, String selectedByPlayer){
        ...
        if(doneBoxes.size() == 9){
            ...
            //final WinDialog winDialog = new WinDialog(fr.ubo.morpion.game.this, "It is a Draw!");
            //winDialog.setCancelable(false);
            //winDialog.show();
        }
    }
